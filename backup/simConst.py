...
sim_modelproperty_not_reset                        =0x0080 # Model is not reset at coppelia end. This flag is cleared at coppelia end
...
sim_simulation_advancing_firstafterstop        =sim_simulation_advancing|0x00        # First coppelia pass (1x)
sim_simulation_advancing_running            =sim_simulation_advancing|0x01        # Normal coppelia pass (>=1x)
# reserved                                    =sim_simulation_advancing|0x02 
sim_simulation_advancing_lastbeforepause    =sim_simulation_advancing|0x03        # Last coppelia pass before pause (1x)
sim_simulation_advancing_firstafterpause    =sim_simulation_advancing|0x04        # First coppelia pass after pause (1x)
sim_simulation_advancing_abouttostop        =sim_simulation_advancing|0x05        # "Trying to stop" coppelia pass (>=1x)
sim_simulation_advancing_lastbeforestop        =sim_simulation_advancing|0x06        # Last coppelia pass (1x)
...
simx_headeroffset_server_state  =17    # 1 byte. Generated by the server. Bit coded 0 set --> coppelia not stopped 1 set --> coppelia paused 2 set --> real-time switch on 3-5 edit mode type (0=no edit mode 1=triangle 2=vertex 3=edge 4=path 5=UI)
...
simx_cmdheaderoffset_sim_time       =20    # 1 simxInt. Generated by the server. The coppelia time (in ms) when the command was executed (or 0 if coppelia is not running)
